CREATE PROCEDURE HABIB.pro_MOVE_and_DEL_TR(
...
WHERE 
    ...
    FOR rec AS cur DO
        ...
        WHERE "SALESTRANSACTIONSEQ" = rec."SALESTRANSACTIONSEQ" ;
         ...
         DELETE FROM HABIB.ZSALESTRANSACTION_ERS
        WHERE "SALESTRANSACTIONSEQ" = rec."SALESTRANSACTIONSEQ" ;
        
         DELETE FROM HABIB.ZSALESTRANSACTION_CALC
        WHERE "SALESTRANSACTIONSEQ" = rec."SALESTRANSACTIONSEQ" ;
